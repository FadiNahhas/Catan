    ...
    public class ComponentInteropHandler : IComponentInteropHandler
    {
        public unsafe ICoherenceComponentData GetComponent(UInt32 type, IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            switch(type)
            {
                ...
                case 153: return _4a1e899db3af4044c84b6b0667e92800_4410974659786363917.FromInterop(data, dataSize, simFrames, simFramesCount);
            }
        ...
        public unsafe void UpdateComponent(CoherenceCore core, InteropEntity entity, ICoherenceComponentData component)
        {
            ...
            switch (componentType)
            {
                ...
                case 153:
                {
                    var orig = (_4a1e899db3af4044c84b6b0667e92800_4410974659786363917)component;
                    var val = new _4a1e899db3af4044c84b6b0667e92800_4410974659786363917.Interop();

                    val.receiveShadows = orig.receiveShadows ? (System.Byte)1 : (System.Byte)0;
