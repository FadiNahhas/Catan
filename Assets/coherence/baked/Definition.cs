...
namespace Coherence.Generated
{
    ...
    {
        public const string schemaId = "aff95018b11ae6bad57f97b97f1bea0a192244a6";
        ...
        public const uint Internal_4a1e899db3af4044c84b6b0667e92800_4410974659786363917 = 153;
        ...
        private static readonly Dictionary<uint, string> componentNamesForTypeIds = new Dictionary<uint, string>() 
        {
            ...
            { 153, "_4a1e899db3af4044c84b6b0667e92800_4410974659786363917" },
        };
            ...
            IInBitStream bitStream, Logger logger)
        {
            ...
            switch (componentType)
            {
                ...
                case Internal_4a1e899db3af4044c84b6b0667e92800_4410974659786363917:
                    return _4a1e899db3af4044c84b6b0667e92800_4410974659786363917.Deserialize(referenceSimulationFrame, inProtocolStream);
                default:
            ...
            AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream protocolStream, Logger logger)
        {
            switch (serializeAs)
            {
                ...
                case Internal_4a1e899db3af4044c84b6b0667e92800_4410974659786363917:
                    return _4a1e899db3af4044c84b6b0667e92800_4410974659786363917.Serialize((_4a1e899db3af4044c84b6b0667e92800_4410974659786363917)data, isRefSimFrameValid, referenceSimulationFrame, protocolStream, logger);
                default:
