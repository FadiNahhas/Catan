...
namespace Coherence.Generated
{
    ...
    public class Binding_4a1e899db3af4044c84b6b0667e92800_bf36d9975a57468cb1cb20f7934379a9 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_4a1e899db3af4044c84b6b0667e92800_e6c38a5207fe49e1bb8fb8152cb01afa : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_4a1e899db3af4044c84b6b0667e92800_153a79d78b184b9b80b0b7d4fb20202e : ScaleBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_4a1e899db3af4044c84b6b0667e92800_80771749291f424f950e507bbfaa34b5 : BoolBinding
    {   
        ...
        public override string CoherenceComponentName => "_4a1e899db3af4044c84b6b0667e92800_4410974659786363917";
        public override uint FieldMask => 0b00000000000000000000000000000001;

        public override System.Boolean Value
        {
            get { return (System.Boolean)(CastedUnityComponent.receiveShadows); }
        ...
        {
            var value = ((_4a1e899db3af4044c84b6b0667e92800_4410974659786363917)coherenceComponent).receiveShadows;

            var simFrame = ((_4a1e899db3af4044c84b6b0667e92800_4410974659786363917)coherenceComponent).receiveShadowsSimulationFrame;
        ...
        public override ICoherenceComponentData WriteComponentData(ICoherenceComponentData coherenceComponent, AbsoluteSimulationFrame simFrame)
        {
            var update = (_4a1e899db3af4044c84b6b0667e92800_4410974659786363917)coherenceComponent;
            if (RuntimeInterpolationSettings.IsInterpolationNone)
            {
            ...
            {
                update.receiveShadows = GetInterpolatedAt(simFrame / InterpolationSettings.SimulationFramesPerSecond);
            }

            update.receiveShadowsSimulationFrame = simFrame;
        ...
        public override ICoherenceComponentData CreateComponentData()
        {
            return new _4a1e899db3af4044c84b6b0667e92800_4410974659786363917();
        }    
    }

    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_4a1e899db3af4044c84b6b0667e92800 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_4a1e899db3af4044c84b6b0667e92800>();
        ...
        {
            ["bf36d9975a57468cb1cb20f7934379a9"] = new Binding_4a1e899db3af4044c84b6b0667e92800_bf36d9975a57468cb1cb20f7934379a9(),
            ["e6c38a5207fe49e1bb8fb8152cb01afa"] = new Binding_4a1e899db3af4044c84b6b0667e92800_e6c38a5207fe49e1bb8fb8152cb01afa(),
            ["153a79d78b184b9b80b0b7d4fb20202e"] = new Binding_4a1e899db3af4044c84b6b0667e92800_153a79d78b184b9b80b0b7d4fb20202e(),
            ["80771749291f424f950e507bbfaa34b5"] = new Binding_4a1e899db3af4044c84b6b0667e92800_80771749291f424f950e507bbfaa34b5(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_4a1e899db3af4044c84b6b0667e92800()
        {
        }
        ...
        public override void ReceiveCommand(IEntityCommand command)
        {
            ...
            {
                default:
                    logger.Warning($"CoherenceSync_4a1e899db3af4044c84b6b0667e92800 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_4a1e899db3af4044c84b6b0667e92800>();
            this.bridge = bridge;
